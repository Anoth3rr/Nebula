...
internal static class AppConfig
{
    ...
    public static string? NebulaLauncherExecutePath { get; private set; }
    ...
    static AppConfig()
    {
        ...
        MutexAndPipeName = $"Nebula.RPC/{Process.GetCurrentProcess().SessionId}/{AppVersion}";
        ...
        string launcherExe = Path.Join(parentFolder, "Nebula.exe");
        if (Directory.Exists(parentFolder) && File.Exists(launcherExe))
        {
            IsPortable = true;
            NebulaLauncherExecutePath = launcherExe;
        }
