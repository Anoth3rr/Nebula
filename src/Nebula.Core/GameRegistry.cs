...
public class GameRegistry
{
    ...
    public const string GamePath_arknights_cn = @"HKEY_CURRENT_USER\Software\Hypergryph\明日方舟";
    public const string GamePath_arknights_global = @"HKEY_CURRENT_USER\Software\Hypergryph\Arknights";
    public const string GamePath_endfield_cn = @"HKEY_CURRENT_USER\Software\Hypergryph\明日方舟：终末地";
    public const string GamePath_endfield_global = @"HKEY_CURRENT_USER\Software\Hypergryph\ArknightsEndfield";

    public const string GamePath_wutheringwaves_cn = @"HKEY_CURRENT_USER\Software\KuroGame\鸣潮";
    public const string GamePath_wutheringwaves_global = @"HKEY_CURRENT_USER\Software\KuroGame\Wuthering Waves";
