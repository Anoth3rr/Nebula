...
namespace Nebula.Core.HoYoPlay;
...
public class GameId : IEquatable<GameId>
{
    ...
    public static GameId? FromGameBiz(GameBiz gameBiz)
    {
        return gameBiz.Value switch
        {
            ...
            GameBiz.wutheringwaves_cn => new GameId { Id = "local_wutheringwaves_cn", GameBiz = "wutheringwaves_cn" },
            GameBiz.wutheringwaves_global => new GameId { Id = "local_wutheringwaves_global", GameBiz = "wutheringwaves_global" },
            _ => null,
        };
    }
