...
public record struct GameBiz
{
    ...
    public const string wutheringwaves = "wutheringwaves";
    public const string wutheringwaves_cn = "wutheringwaves_cn";
    public const string wutheringwaves_global = "wutheringwaves_global";
    ...
    public bool IsHoYoPlayGame() => Game switch
    {
        bh3 or hk4e or hkrpg or nap => true,
        _ => false,
    };
    ...
    public string ToGameName() => Game switch
    {
        ...
        wutheringwaves => CoreLang.Game_WutheringWaves,
        _ => "",
    };
    ...
    public string GetGameRegistryKey() => Value switch
    {
        ...
        wutheringwaves_cn => GameRegistry.GamePath_wutheringwaves_cn,
        wutheringwaves_global => GameRegistry.GamePath_wutheringwaves_global,
        _ => "HKEY_CURRENT_USER",
    };
