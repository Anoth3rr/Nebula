...
public class DownloadService
{
    ...
    protected void RecreateHttpClient()
    {
        ...
        _httpClient.DefaultRequestHeaders.Add("User-Agent", $"Nebula.Setup/{ver}");
    ...
    {
        if (Path.Combine(installFolder, "Nebula.Setup.exe") != Environment.ProcessPath)
        {
            Directory.CreateDirectory(installFolder);
            File.Copy(Environment.ProcessPath!, Path.Combine(installFolder, "Nebula.Setup.exe"), true);
        }
    }
