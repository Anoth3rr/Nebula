...
internal partial class GameFeatureConfig
{
    ...
    public static GameFeatureConfig FromGameId(GameId? gameId)
    {
        ...
        GameFeatureConfig config = gameId.GameBiz.Value switch
        {
            ...
            GameBiz.wutheringwaves_cn => wutheringwaves,
            GameBiz.wutheringwaves_global => wutheringwaves,
            _ => Default,
        };
        return config;
    }
    ...
    private static readonly GameFeatureConfig arknights = new()
    {
        SupportedPages =
        [
    ...
    private static readonly GameFeatureConfig endfield = new()
    {
        SupportedPages =
        [
            nameof(GameLauncherPage),
